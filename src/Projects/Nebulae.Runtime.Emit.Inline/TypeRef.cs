...
#pragma warning disable IDE0060
    ...
    public sealed class TypeRef
    {
        ...
        /// <summary>
        /// 获取指定名称、泛型参数数量和参数类型的泛型方法定义的引用
        /// </summary>
        /// <param name="name">方法名称</param>
        /// <param name="genericParameterCount">泛型参数数量</param>
        /// <param name="parameterTypes">参数类型</param>
        /// <returns>表示泛型方法定义引用的 <see cref="MethodRef"/>。</returns>
        /// <remarks>使用 <see cref="GenericRef"/> 匹配目标中的泛型参数声明。</remarks>
        [Reference(ReferenceType.Method)]
        public MethodRef Method(string name, int genericParameterCount, params Type[] parameterTypes)
        {
            return IL.Throw<MethodRef>();
        }
