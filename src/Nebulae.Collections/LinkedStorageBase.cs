...
namespace Nebulae.Collections
{
    ...
    public abstract class LinkedStorageBase<T> : IEnumerable<T>
    {
        ...
        /// </summary>
        protected internal sealed class Node : IEquatable<Node>
        {
            //------------------------------------------------------
            //
            //  Public Fields
            ...
            /// <summary>
            /// 判断两个 <see cref="Node"/> 是否相等
            /// </summary>
            /// <param name="left">要比较的第一个 <see cref="Node"/></param>
            /// <param name="right">要比较的第二个 <see cref="Node"/></param>
            /// <returns>若两个 <see cref="Node"/> 相等，返回 <see langword="true"/>；反之则返回 <see langword="false"/>。</returns>
            ...
            /// <summary>
            /// 判断两个 <see cref="Node"/> 是否不等
            /// </summary>
            /// <param name="left">要比较的第一个 <see cref="Node"/></param>
            /// <param name="right">要比较的第二个 <see cref="Node"/></param>
            /// <returns>若两个 <see cref="Node"/> 不等，返回 <see langword="true"/>；反之则返回 <see langword="false"/>。</returns>
            public static bool operator !=(Node? left, Node? right)
            {
                if (ReferenceEquals(left, right))
                {
